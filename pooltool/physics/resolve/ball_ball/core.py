...
class CoreBallBallCollision(ABC):
    ...
    def make_kiss(self, ball1: Ball, ball2: Ball) -> tuple[Ball, Ball]:
        ...
        if (
            ...
            r1_corrected, r2_corrected = _apply_fallback_positioning(
    ...
    def resolve(
        ...
        ball1, ball2 = _resolve_continually_touching(ball1, ball2)
...
def _resolve_continually_touching(ball1: Ball, ball2: Ball) -> tuple[Ball, Ball]:
